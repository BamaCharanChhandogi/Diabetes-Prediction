      ...
      {modalImage && (
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-4 rounded-lg shadow-lg flex flex-col">
           ...
           <button className="p-2 bg-transparent text-red-500 hover:text-gray-800 focus:outline-none" onClick={closeModal}>
            <IoClose className='w-9 h-9' />
            </button>
           </div>
            <img src={modalImage} alt="Correlation Heatmap" className="mx-auto w-full h-96 object-cover rounded-lg" />
          </div>
        </div>
      )}
    </div>
