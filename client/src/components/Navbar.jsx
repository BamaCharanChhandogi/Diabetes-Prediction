...
import logoDiabetes from '../assets/logo_diabetes.png'; // Adjust the path as per your directory structure
...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-800 sticky z-50 top-0" style={{ height: "2cm" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0 flex items-center">
            <Link to="/" className="flex items-center text-white font-bold">
              <img src={logoDiabetes} className="h-10 mr-2" style={{ maxHeight: "100%", maxWidth: "auto" }} alt="Logo" /> 
              <span style={{ fontSize: "1.2rem" }}> Diabetes Prediction App</span>
            </Link>
          </div>
